...
A new title goes before `--description` rather than after its single argv token, because trailing words would otherwise land as a rename; they exit with code 2 instead.
